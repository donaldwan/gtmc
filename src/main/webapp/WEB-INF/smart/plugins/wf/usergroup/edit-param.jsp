...
<div id="win-id-plugin-wf-usergroup-Param-edit" class="col-sm-12 col-md-12 col-lg-12"  style="padding-right:60px;padding-top:15px;">
    <form class="form-horizontal" id="id-edit-form-usergroup-param">
		<div class="form-group">
			<label class="col-sm-4 control-label no-padding-right" for="paramType"><font color="red">*</font>参数类型:</label>
			<div class="col-sm-8">
				<select class="form-control" name="paramType" id="id-paramType">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<input type="text" name="paramName" id="id-paramName" placeholder="请输入参数名称..." class="form-control" value="${model.paramName }" />
			</div>
		</div>
...
<script type="text/javascript">
	loadScript("${ctx}/static/modules/plugins/wf/usergroup/edit-param.js",function(){
		$.plugins.wf.usergroup.editParam.init();
	});
</script>
