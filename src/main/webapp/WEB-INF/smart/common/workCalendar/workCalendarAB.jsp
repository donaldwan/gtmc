...
<div id="common-calendar">
			...
			<div class="widget-body">
				<div class="well">
					<form id="common-calendar-form"  class="form-inline" method="post">
						<div>
								<input id = "common-calendar-calendarType" name="calendarType" value="1" type = "hidden"/>
								...
								<div class="row">
									...
									<span style="display:inline-block;border-radius: 4px;margin-top:5px;width:35px;height:15px;background-color:#0AF047;"></span>早班为A班
									<span style="display:inline-block;border-radius: 4px;margin-top:5px;width:35px;height:15px;background-color:#F7EF02;"></span>早班为B班
								</div>
						...
						<div>
							...
							<a id="bt-save-workdayA" class="btn btn-success btn-sm" href="javascript:void(0);" style="background-color:#0AF047;border:1px solid #0AF047;" ><i class="fa fa-plus" ></i>&nbsp;保存早班为A班</a>
							<a id="bt-save-workdayB" class="btn btn-success btn-sm" href="javascript:void(0);" style="background-color:#F7EF02;border:1px solid #F7EF02;" ><i class="fa fa-plus" ></i>&nbsp;保存早班为B班</a>
 ...
 <script type="text/javascript">
	loadScript("${ctx}/static/modules/common/workCalendar/workCalendarAB.js", function() {
		$.common.workCalendarAB.init();
	});
</script>
