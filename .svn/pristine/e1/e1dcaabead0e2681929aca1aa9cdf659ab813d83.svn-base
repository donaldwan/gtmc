...
<div id="win-id-plugin-wf-usergroup-edit" class="col-sm-12 col-md-12 col-lg-12">
    <form class="form-horizontal" id="id-edit-form-usergroup">
		...
		<div class="form-group">
			<label class="control-label col-sm-2 no-padding-right" for="remark">备注:</label>
			<div class="col-sm-10">
