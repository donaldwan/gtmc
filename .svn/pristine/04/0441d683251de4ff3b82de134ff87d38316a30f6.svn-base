...
<div id="win-id-plugin-wf-usergroup-Param-Sys-edit-choose" class="col-sm-12 col-md-12 col-lg-12"  style="padding-right:60px;padding-top:15px;">
    <form class="form-horizontal" id="id-edit-form-usergroup-param-sys-choose">
		...
		<div class="form-group">
			...
			<div class="col-sm-8">
				<select class="form-control" name="paramType" id="paramType" onchange="$.plugins.wf.usergroup.editParamSys_choose.changeParamType(this);">
		...
		<div class="form-group" id="id-paramType-bp">
			...
			<div class="col-sm-8">
				<select class="form-control" name="paramInfoBp" id="paramInfoBp" onchange="$.plugins.wf.usergroup.editParamSys_choose.changeParamInfoBp();">
		...
		<div id="id-paramType-sys" style="display: none;">
			<div class="form-group">
				...
				<div class="col-sm-8 input-group">
					...
					<span class="input-group-addon" onclick="$.plugins.wf.usergroup.editParamSys_choose.selectSysInfo();"><i class="fa fa-search-plus"></i></span>
				</div>
			</div>			
		</div>
...
<script type="text/javascript">
	loadScript("${ctx}/static/modules/plugins/wf/usergroup/choose/edit-param-sys.js",function(){
		$.plugins.wf.usergroup.editParamSys_choose.init();
	});
</script>
